$(document).ready(function(){
	...
	// Calendar icon
	$('#calendar-icon-svg').attr('src','http://louisville.edu/ideastoaction/-/images/home/calendar/' + (new Date).getMonth() + '.svg');
	$('#calendar-icon-png').attr('src','http://louisville.edu/ideastoaction/-/images/home/calendar/' + (new Date).getMonth() + '.png');
