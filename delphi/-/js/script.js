$(document).ready(function(){
	...
	// Calendar icon
	$('#calendar-icon-svg').attr('src','http://louisville.edu/delphi/-/images/home/calendar/' + (new Date).getMonth() + '.svg');
	$('#calendar-icon-png').attr('src','http://louisville.edu/delphi/-/images/home/calendar/' + (new Date).getMonth() + '.png');
